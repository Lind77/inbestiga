 ...
 */
    ...
    {
        $quotation = Quotation::where('id', $id)->with(['customers', 'customers.province', 'customers.province.department', 'customers.province.department.provinces', 'customers.user', 'customers.comunications', 'details', 'details.product', 'order', 'contract', 'contract.user', 'contract.projects', 'contract.projects.team', 'contract.projects.team.users', 'contract.payments', 'contract.properties', 'contract.projects.team.users.roles', 'contract.projects.files', 'contract.projects.deliveries', 'contract.projects.posts' => function ($query) {
