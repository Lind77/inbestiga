...
class CustomerController extends Controller
{
    ...
    public function show($id)
    {
        $customer = Customer::with(['quotations' => function ($query) {
            $query->with(['details', 'details.product', 'order', 'order.payments', 'contract', 'contract.payments', 'contract.projects', 'contract.deliveries'])->orderBy('created_at', 'desc')->first();
        }])->find($id);
