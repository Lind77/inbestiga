...
{
    use HasFactory;
    protected $fillable = ['assigned_activitiable_id', 'assigned_activitiable_type', 'name', 'date', 'academic_date', 'type', 'progress', 'status', 'priority', 'user_id', 'points','academic_process_id','type'];
