...
class Contract extends Model
{
    ...
    protected $fillable = ['quotation_id', 'amount', 'amount_text', 'cent_text', 'date', 'advance', 'percentage', 'third_article','third_article_place','status', 'fifth_article','third_article_ppts'];
