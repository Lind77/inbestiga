<template>
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-1">Precios <span class="badge bg-label-primary me-1 cursor-pointer"
                @click="openNewProductModal">+</span></h4>
        <div class="col-xl-12">
    ...
    <InsertNewProduct @getAllProductsWithPrices="getAllProductsWithPrices" />
</template>
<script>
