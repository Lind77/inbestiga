<template>
  <div class="container-xxl flex-grow-1 container-p-y">
      ...
      <div class="col-xl-12 col-lg-12">
        <div class="card">
          ...
          <div class="row ms-2">
            ...
            <input type="date" @change="searchCustomersByDate" class="form-control w-25 ms-2" v-model="searchDate">
          </div>
    ...
    <customerModal :customer="customer_selected" :action="action" :allUsers="allUsers"
...
export default {
  ...
  methods: {
    ...
    searchCustomersByDate() {
      axios.get('/api/customers/search-by-date/' + this.searchDate)
        .then((res) => {
          console.log(res)
