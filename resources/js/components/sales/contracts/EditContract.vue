                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <dl class="row mb-2">
                                    ...
                                    <dd class="col-sm-6 d-flex justify-content-md-end">
                                        <div class="w-px-150">
                                            <input v-if="idQuotation" type="text" class="form-control" v-model="idQuotation"
                                                disabled>
                                        </div>
                                    </dd>
                                    <dt class="col-sm-6 mb-2 mb-sm-0 text-md-end">
                        ...
                        <div class="row p-sm-3 p-0">
                            ...
                            <div class="col-md-6 col-sm-7">
                                <p>Considerar "Proporcionar la información de la aplicación de instrumentos" <input
                                        type="checkbox" class="form-check-input" v-model="thirdArticle"></p>
