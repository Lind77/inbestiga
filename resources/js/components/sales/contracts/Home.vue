          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <form class="source-item py-sm-3">
                <div class="row">
                  <div class="col-12">
                    <button type="button" class="btn btn-primary" data-repeater-create="" @click="addDelivery">Agregar
                      Entrega</button>
                  </div>
                </div>
              </form>
        ...
        <div class="card mb-4">
          <div class="card-body">
            ...
            <a v-if="idContract != 0 && typeDocument == 2"
              :href="`https://sistema.avantage.com/public/api/generateContract/${idContract}`" target="_blank"
