                ...
                <div class="col-lg-3 col-12 invoice-actions">
                  ...
                  <div class="card mb-4">
                    <div class="card-body">
                      ...
                      <a v-if="idContract != 0 && typeDocument == 2" :href="`/../../inbestiga/public/api/generateContract/${customer.id}`" target="_blank" class="btn btn-primary d-grid w-100 mb-3">Contrato</a>
