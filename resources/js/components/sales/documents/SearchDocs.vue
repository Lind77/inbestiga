    ...
    <div class="row">
        <div class="col-6">
            <div class="input-group ps-3">
                <input type="text" class="form-control" placeholder="Nombre de cliente" aria-label="Recipient's username"
                    v-model="searchWord" @keyup.enter="searchDoc" aria-describedby="button-addon2">
