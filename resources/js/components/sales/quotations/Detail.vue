<template>
    <div class="repeater-wrapper pt-0 pt-md-4" data-repeater-item="">
        ...
        <div class="row w-100 m-0 p-3">
            ...
            <div class="col-md">
                <div class="form-check mt-3">
                    <input class="form-check-input" type="radio" v-model="detail.mode" @click="selectMode" value="1" :id="`type1-${detail.id}`">
                    <label class="form-check-label" :for="`type1-${detail.id}`"> Fragmentado </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" v-model="detail.mode" @click="selectMode" value="2" :id="`type-${detail.id}`">
            ...
            <input v-if="detail.new_product != null" type="text" class="form-control" @keyup="searchNewProduct" v-model="detail.new_product.name">
        ...
        <div class="d-flex flex-column align-items-center justify-content-between border-start p-2">
            ...
            <div class="dropdown">
            <i class="bx bx-cog bx-xs text-muted cursor-pointer more-options-dropdown" role="button" id="dropdownMenuButton" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="true">
            </i>
            <div class="dropdown-menu dropdown-menu-end w-px-300 p-3" aria-labelledby="dropdownMenuButton" style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate3d(0px, 23.2px, 0px);" data-popper-placement="bottom-end">
