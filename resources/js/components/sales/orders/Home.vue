          ...
          <div class="card-body">
            ...
            <div class="row p-sm-3 p-0">
              ...
              <div class="row py-sm-3">
                ...
                <hr class="my-4 mx-n4">
                <div class="row py-sm-3">
                  <Payments :totalFinal="totalProducts - discount" :payments="payments" @addFee="addFee"/>
                </div>
                  ...
                  <div class="card mb-4">
                    <div class="card-body">
                      ...
                      <button @click="insertQuotation" class="btn btn-primary d-grid w-100 mb-3" >
                        <span class="d-flex align-items-center justify-content-center text-nowrap"><i class="bx bx-paper-plane bx-xs me-1"></i>Almacenar</span>
                      </button>
                      ...
                      <router-link v-if="idOrder != 0" target="_blank" :to="{name:'order-file', params:{ id: idOrder }}" class="btn btn-secondary d-grid w-100 mb-3">Orden</router-link>
