<template>        
    ...
    <div class="card-body">
        ...
        <i v-if="project.status == 2" class='bx bx-list-check text-primary cursor-pointer' @click="showQualityModal"></i>
        ...
        <i v-if="project.numTasksCompleted/project.numTasks == 1 && project.status == 1" @click="updateQuality" class='bx bx-check-circle text-success cursor-pointer'></i>
