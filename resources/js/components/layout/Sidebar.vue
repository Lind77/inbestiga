    ...
    >
        <div class="app-brand demo py-3 px-4 d-flex align-items-center">
            <a href="#" class="app-brand-link d-flex align-items-center">
                <img src="/img/logo_ag.png" alt="AVANTAGE" height="38" class="me-2" style="object-fit: contain;" />
                <span class="fw-bold text-title-custom font-montserrat" style="font-size: 1.1rem; letter-spacing: 1px;">AVANTAGE <span class="fw-normal" style="font-size: 0.6em; letter-spacing: 2px;">GROUP</span></span>
            </a>
            <a
