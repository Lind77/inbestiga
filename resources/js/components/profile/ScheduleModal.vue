            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="alert alert-warning" role="alert">
                        La cantidad de horas se destribuirá en intervalos de una
                        hora.
                        <p
                            v-if="
                            ...
                            "
                        >
                            Recuerda, si eres parte del equipo académico la
                            entrada es desde las 7:00 am hasta las 7:30pm
                        </p>
                    </div>
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input
                                type="time"
                                v-model="schedule.admission_time"
                                class="form-control"
                            />
                        </div>
                        <div class="col mb-3">
...
export default {
    ...
    methods: {
        addSchedule() {
            ...
            var admissionTime = moment(
                this.schedule.admission_time,
                "HH:mm"
            ).toDate();
            var deptTime = moment(
