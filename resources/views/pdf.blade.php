...
<head>
    ...
    <title>Avantage - Cotización</title>
    ...
    <style>
        *{
        ...
        body{
            ...
            background: url('https://www.jairpl.com/avantage/markwater.png') ;
...
<body>
    <img class="header" src="https://www.jairpl.com/avantage/header.png">
    ...
    <img class="footer" src="https://www.jairpl.com/avantage/footer.png">
</body>
</html>